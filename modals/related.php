...
if (isset($_GET['id'])) {
    ...
    if ($item !== false) {
        ...
        <div class="lor-modal-header">
            <h4 class="lor-modal-title col-12 text-center" id="myModalLabel">Related Functionality is Currently Under
                Construction</h4>
        ...
        <div class="lor-modal-body">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <p style="max-width: 815px">Items in the Learning Object Repository which are often used in
                        conjunction with the item you clicked will be shown here. For examle, if you clicked on a video,
                        the lesson in which that video is referenced may appear here, as well as any other items which
                        also appear in that lesson.</p>
                </div>
            </div>
            <!-- End of modal HTML. -->
        </div>
