...
class search_form extends moodleform {
    ...
    protected function definition() {
        ...
        // Sort by.
        $mform->addElement('select', 'sort_by', get_string('sort_by', 'local_lor'), array('new'          => get_string('recently_added', 'local_lor'),
                                                                                          'alphabetical' => get_string('alphabetical', 'local_lor'),
        ));
