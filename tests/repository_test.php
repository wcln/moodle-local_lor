...
class local_lor_repository_testcase extends advanced_testcase {
    public function test_format_filepath() {
        $test_filepaths = [
            [
            ...
            [
                'raw' => 'projects/This ^$is a _test!.png',
                'expected' => 'projects/this is a _test.png'
            ]
        ];

        foreach ($test_filepaths as $filepath) {
            $this->assertEquals($filepath['expected'], \local_lor\repository::format_filepath($filepath['raw']));
        }
    }
}
