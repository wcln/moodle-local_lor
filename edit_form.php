...
class edit_form extends moodleform {
    ...
    protected function definition() {
        ...
        foreach ($categories_arr as $id => $category_name) {
            $category_item[] = &$mform->createElement('advcheckbox', $id, '', $category_name, array('name'  => $id,
                                                                                                    'group' => 1,
            ), $id);
        }
        ...
        foreach ($grades_arr as $grade) {
            $grade_item[] = &$mform->createElement('advcheckbox', $grade, '', $grade, array('name'  => $grade,
                                                                                            'group' => 2,
            ), $grade);
        }
        ...
        if (isset($this->_customdata['type'])) {
            ...
            switch ($this->_customdata['type']) {
                ...
                case 1:
                    ...
                    $mform->addELement('filepicker', 'image', get_string('image', 'local_lor'), null, array('maxbytes'       => 1000000,
                ...
                case 7:
                    ...
                    // Word Document.
                    $mform->addElement('filepicker', 'word', get_string('word', 'local_lor'), null, array('maxbytes'       => 10000000,
                                                                                                          'accepted_types' => array('.docx'),
                    ));

                    // PDF.
                    $mform->addElement('filepicker', 'pdf', get_string('pdf', 'local_lor'), null, array('maxbytes'       => 10000000,
                                                                                                        'accepted_types' => array('.pdf'),
                    ));

                    // Image file.
                    $mform->addElement('filepicker', 'icon', get_string('icon', 'local_lor'), null, array('maxbytes'       => 10000000,
                                                                                                          'accepted_types' => array('.png'),
                    ));
